...
window.KF_CONFIG = {
  ...
  menu: [
    ...
    // SANDWICHES
    {id:'sw1', name:'Chicken Sandwich', price:380, cat:'Sandwiches', tag:'Classic', img:'images/burger.png'},
    {id:'sw2', name:'Fajita Sandwich', price:480, cat:'Sandwiches', tag:'Spicy', img:'images/burger.png'},
    {id:'sw3', name:'Cheesy Grill Sandwich', price:510, cat:'Sandwiches', tag:'Cheesy', img:'images/burger.png'},
    {id:'sw4', name:'Club Sandwich', price:510, cat:'Sandwiches', tag:'Classic', img:'images/burger.png'},

    // WRAPS
    {id:'w1', name:'Thousand Wrap', price:600, cat:'Wraps', tag:'Saucy', img:'images/shawarma.png'},
    {id:'w2', name:'Chipotle Wrap', price:600, cat:'Wraps', tag:'Spicy', img:'images/shawarma.png'},
    {id:'w3', name:'Garlic Wrap', price:600, cat:'Wraps', tag:'Garlic', img:'images/shawarma.png'},
    {id:'w4', name:'Cheesy Wrap', price:670, cat:'Wraps', tag:'Cheesy', img:'images/shawarma.png'},
    {id:'w5', name:'Anabei Wrap', price:650, cat:'Wraps', tag:'Special', img:'images/shawarma.png'},
    {id:'w6', name:'Turkish Wrap', price:650, cat:'Wraps', tag:'Special', img:'images/shawarma.png'},
    ...
    // CRISPY CORNER
    {id:'cc1', name:'Hot Wings (5 Pcs)', price:400, cat:'Crispy Corner', tag:'Spicy', img:'images/fries.png'},
    {id:'cc2', name:'Hot Wings (10 Pcs)', price:700, cat:'Crispy Corner', tag:'Spicy', img:'images/fries.png'},
    {id:'cc3', name:'Nuggets (5 Pcs)', price:350, cat:'Crispy Corner', tag:'Crispy', img:'images/fries.png'},
    {id:'cc4', name:'Nuggets (10 Pcs)', price:600, cat:'Crispy Corner', tag:'Crispy', img:'images/fries.png'},

    // BEVERAGES
    {id:'bev1', name:'Pepsi (345ml)', price:80, cat:'Beverages', tag:'Chilled', img:'images/pizza.png'},
    {id:'bev2', name:'7 Up (345ml)', price:80, cat:'Beverages', tag:'Chilled', img:'images/pizza.png'},
    {id:'bev3', name:'Dew (345ml)', price:80, cat:'Beverages', tag:'Chilled', img:'images/pizza.png'},
    {id:'bev4', name:'Fanta (345ml)', price:80, cat:'Beverages', tag:'Chilled', img:'images/pizza.png'},
    {id:'bev5', name:'Sting (345ml)', price:90, cat:'Beverages', tag:'Energy', img:'images/pizza.png'},
    {id:'bev6', name:'Mineral Water (500ml)', price:50, cat:'Beverages', tag:'Pure', img:'images/pizza.png'},
    {id:'bev7', name:'Mineral Water (1.5 Litre)', price:100, cat:'Beverages', tag:'Pure', img:'images/pizza.png'},
